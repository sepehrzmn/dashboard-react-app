...
export const gridOrderImage = (props) => (
  <div>
    <img className="rounded-xl h-20 w-20 md:ml-3" src={props.ProductImage} alt="order-item" />
  </div>
);
...
const customerGridStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize dark:text-slate-300">
